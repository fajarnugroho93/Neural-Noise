...
namespace TurnBasedSystem.Editor
{
    ...
    {
        private const string EnumFilePath = "Assets/Scripts/TurnBasedSystem/Characters/Skills/Skill.cs";

        private static TurnBasedEditor _parentEditor;
        private string _skillName = "";
        private string _errorMessage = "";
        private SkillTarget _skillTarget = SkillTarget.None;
        ...
        private void OnGUI()
        {
            ...
            _skillTarget = (SkillTarget)EditorGUILayout.EnumPopup("Skill Target:", _skillTarget);
