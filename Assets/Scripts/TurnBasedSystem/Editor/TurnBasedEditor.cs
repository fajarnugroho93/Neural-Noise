...
namespace TurnBasedSystem.Editor
{
    public class TurnBasedEditor : EditorWindow
    {
        ...
        private const string CharacterEnumFilePath = "Assets/Scripts/TurnBasedSystem/Characters/Character.cs";
        private const string SkillEnumFilePath = "Assets/Scripts/TurnBasedSystem/Characters/Skills/Skill.cs";

        private const string SkillEffectEnumFilePath =
            "Assets/Scripts/TurnBasedSystem/Characters/Skills/SkillEffect.cs";
        ...
        private void LoadUIElements()
        {
            ...
            var styleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Scripts/TurnBasedSystem/Editor/TurnBasedEditor.uss");
            if (styleSheet != null)
            {
                root.styleSheets.Add(styleSheet);
            }

            var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Scripts/TurnBasedSystem/Editor/TurnBasedEditor.uxml");
            if (visualTree != null)
            {
